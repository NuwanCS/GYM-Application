...
class UI {
  ...
  getBagButtons() {
    //below sperad operator is used bcz then we have all the buttons as
    //an array otherwise it will be a nodelist
  ...
  setCartValues(cart) {
    ...
    document.querySelector(".cart-total").innerText = parseFloat(
      tempTotal.toFixed(2)
    );
    document.querySelector(".cart-item").innerText = itemsTotal;
  }
